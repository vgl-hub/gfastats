                                ...
                                case 'P': {
                                    ...
                                    for (auto it = std::begin(components); it != std::end(components); ++it) {
                                        ...
                                        if(it == std::begin(components) && *it == "") { // handle starting/ending gap
                                                ...
                                                auto gId = find_if(inGaps->begin(), inGaps->end(), [sId1](InGap& obj) {return (obj.getsId1() == sId1 && obj.getsId2() == sId1) || (obj.getsId1() == sId2 && obj.getsId2() == sId1);}); // given a uId, find it in gaps
